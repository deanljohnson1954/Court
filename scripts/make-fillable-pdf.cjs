// UW Court — Fillable Rental Application PDF
...
async function build() {
  ...
  txt('UW COURT  –  Student Rental Application  –  5031 19th Ave NE, Seattle WA 98105  –  uwcourt@gmail.com',
  ...
  txt('UW COURT',                    38, 740, 22, B, GOLD);
  txt('STUDENT RENTAL APPLICATION',  38, 720, 12, B, GOLD_LIGHT);
  txt('5031 19th Ave NE  ·  Seattle, WA 98105  ·  706-603-0022  ·  uwcourt@gmail.com',
  ...
  txt('uwcourt@gmail.com  ·  706-603-0022  ·  5031 19th Ave NE, Seattle WA 98105',
  ...
  txt('Please include a copy of your University of Washington Student ID and your Driver\'s License or Passport with each application.',
    36, 124, 7.5, B, GREEN);
  txt('Once all group members have completed their applications, submit them together as one package to uwcourt@gmail.com.',
